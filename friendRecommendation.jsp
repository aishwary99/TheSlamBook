...
<head>
    ...
    <title>RecommendedResults</title>
    <!-- Custom CSS -->
    <link href="dist/css/style.min.css" rel="stylesheet">
   <script>
window.addEventListener("load",friendRecommenderService);
function friendRecommenderService()
{
var baseURL="/slamBook/";
var code=${memberBean.code};
var codeJson={
"code":code
};
$.ajax({
"url":baseURL+"friendRecommender",
"type":"POST",
"dataType":"json",
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/slamBook/getMembers" aria-expanded="false">
                                <i class="ti-user"></i>
            ...
            <div class="page-breadcrumb">
                    <div class="row">
                            <div class="col-5 align-self-center">
                                <h4 class="page-title">Recommendations</h4>
                    ...
                    <div class="table-responsive m-t-20">
                            <%
                            List<Member> recommendedResults=(List<Member>)session.getAttribute("recommendedFriends");
                            if(recommendedResults==null || recommendedResults.size()==0)
                           {
                          ...
                          { 
                            for(Member m:recommendedResults)
                            {   
                            %>   
                            <table class="table table-responsive-sm">
                                <tbody>
                                    <tr>
                                        ...
                                        <th style="padding-top:30px;">
                                            <input style="width:150px;" type="button" class="btn btn-primary" value="Add Friend">
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
